...
% addpath(genpath('D:\wjvhaute\Matlab\Bartlett-Lewis Optimization toolbox\'));
...
SAVE = ['.\TBLGPAPERREP_gammainc_56.mat'];


output=momFit(MODEL,OBSERVATIONS,OBJFN,ROUTINE,MONTH,REPEAT,getRules,getBoundaries(MODEL),SAVE,[]);
