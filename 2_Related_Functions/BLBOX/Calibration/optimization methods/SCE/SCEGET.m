function VAL = SCEGET(OPTIONS,name,default,flag)
%SCEGET Get SCE OPTIONS parameters.
%   VAL = SCEGET(OPTIONS,'NAME') extracts the value of the named parameter
...
%   argument.
%
%   VAL = SCEGET(OPTIONS,'NAME',DEFAULT) extracts the named parameter as
%   above, but returns DEFAULT if the named parameter is not specified (is [])
%   in OPTIONS.  For example
%
%     val = SCEGET(opts,'TolX',1e-4);
%
