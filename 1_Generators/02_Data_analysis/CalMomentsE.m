function statistics=CalMomentsE(data,rep,agg,orig,zdpflag, fignumber)
%% CalMomentsE Function to calculate the moments of E and to make a plot of these
...
set(gcf,'color','white')
ylabels={'Mean [mm]','Variance [mm²]','Autocovariance [mm²]'};
for i = 1:3
