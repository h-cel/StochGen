function statistics=CalMomentsQ(data,rep,agg,orig,zdpflag, fignumber)
%% CalMomentsQ Function to calculate the moments of T and to make a plot 
%
%   Inputs:
...
set(gcf,'color','white')
ylabels={'Mean [m^3/s]','Variance [(m^3/s)^2]','Autocovariance [(m^3/s)^2]'};
for i = 1:3
